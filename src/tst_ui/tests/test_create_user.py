...
from src.tst_ui.base_objects.elemients.dropdown_all.individual import Individual
from src.tst_ui.base_objects.elemients.header import Header
from src.modules.helpers.timeouts import Timeouts
from src.tst_ui.pages.login_page import LoginPage


class TestUserCreate:
    @title('ТК_А1 - Создание физического лица')
    def test_create_fl(self, page: Page):
        ...
        with step('Переходим на страницу "Создать физическое лицо"'):
